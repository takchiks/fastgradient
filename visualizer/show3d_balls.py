...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='../examples', help='dataset path')
    ...
    from ModelNetDataLoader import farthest_point_sample
    ...
    with open('../../../PointClouds/Pointnet_Pointnet2_pytorch/data/modelnet40_normal_resampled/glass_box/glass_box_0250.txt', 'r') as data:
    # with open('../examples/0.0001and10/glass_box/glass_box_0250.txt', 'r') as data:
        for line in data:
            point_list.append([])
