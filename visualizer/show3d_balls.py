...
if __name__ == '__main__':
    ...
    point_list = []
    i = 0
    # with open('../../../PointClouds/Pointnet_Pointnet2_pytorch/data/modelnet40_normal_resampled/guitar/guitar_0205_diff.txt', 'r') as data:
    with open('../examples/5e-05and10/guitar/guitar_0205_diff.txt', 'r') as data:
        for line in data:
            point_list.append([])
