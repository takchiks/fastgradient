...
if __name__ == '__main__':
    ...
    # with open('../../../PointClouds/Pointnet_Pointnet2_pytorch/data/modelnet40_normal_resampled/guitar/guitar_0166.txt', 'r') as data:
    with open('../examples/0.1and3/guitar/guitar_0166_diff.txt', 'r') as data:
        for line in data:
            point_list.append([])
